        ...
        <div class="content">
            <div class="page-header">
                <div>
                    ...
                    <h1 class="page-title"><strong>Lista de</strong> Empresas</h1>
                </div>
                <div class="page-header-actions">
                    <a href="enterprise_create.php" class="btn btn-primary">
                            ...
                            <?php if ($result->num_rows > 0): ?>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars(formatarCNPJ($row['cnpj_empresa'])) ?></td>
                                        <td class="td-actions">
                                            <div class="td-actions-wrap">
                                                <a href="enterprise_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Editar</a>
                                                <a href="delete.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Tem certeza que deseja desativar?')">Desativar</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
